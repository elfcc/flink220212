 ...
 * @Version 1.0
 */
public class Flink04_EvenTime_WaterMark_bonud_session {
    public static void main(String[] args) throws Exception {
        ...
        //TODO 开启一个窗口  会话窗口的  间隔为三秒
        WindowedStream<WaterSensor, Tuple, TimeWindow> window = id.window(EventTimeSessionWindows.withGap(Time.seconds(3)));
