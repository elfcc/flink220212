 ...
 * @Version 1.0
 */
public class Flink01_EvenTime_WaterMark_Montonous {
    public static void main(String[] args) throws Exception {
        ...
        WindowedStream<WaterSensor, Tuple, TimeWindow> window = id.window(TumblingEventTimeWindows.of(Time.seconds(6)));
