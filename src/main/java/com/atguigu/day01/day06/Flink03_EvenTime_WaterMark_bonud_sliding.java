 ...
 * @Version 1.0
 */
public class Flink03_EvenTime_WaterMark_bonud_sliding {
    public static void main(String[] args) throws Exception {
        ...
        WindowedStream<WaterSensor, Tuple, TimeWindow> window = id.window(SlidingEventTimeWindows.of(Time.seconds(6),Time.seconds(3)));
